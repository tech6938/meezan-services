                                ...
                                <table class="table table-striped" id="table-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $request['user_name'] }}</td> <!-- Displaying the user_name -->
                                            <td>
                                                <span class="badge {{ $request['status'] == 'approved' ? 'badge-success' : 'badge-warning' }}">
                                                    {{ $request['status'] }}
                                                </span>
                                            </td>
                                            <td>{{ $request['lang'] }}</td>
                                            <td>{{ $request['lat'] }}</td>
                                            <td>
                                                <button class="btn btn-primary openModalBtn" data-provider-id="{{ $request['id'] }}">
