...
@section('css')
    ...
    <style>
        ...
        .goto-0 { background: #e9ecef; color: #495057; }
        .goto-1 { background: #28a745; color: white; }
        .goto-2 { background: #17a2b8; color: white; }
        .assigned-badge {
            font-size: 10px;
            padding: 2px 8px;
            border-radius: 10px;
        }
        .assigned-0 { background: #ffc107; color: #212529; }
        .assigned-1 { background: #28a745; color: white; }
                                ...
                                <div class="section-title">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <span class="badge badge-info">{{ ucfirst($serviceRequest->status ?? 'N/A') }}</span>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <strong>Created At:</strong> {{ $serviceRequest->created_at ? $serviceRequest->created_at->format('Y-m-d H:i:s') : 'N/A' }}
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <div class="card provider-card">
                                                <div class="card-body text-center">
                                                    ...
                                                    <div class="mt-2">
                                                        <span class="status-badge status-{{ strtolower(str_replace(' ', '-', $currentProvider['status'])) }}">
                                                            {{ $currentProvider['status'] }}
                                                        </span>
                                                        {{-- <span class="goto-badge goto-{{ $currentProvider['goto'] }}">
                                                            Goto: {{ $currentProvider['goto'] }}
                                                        </span> --}}
                                                        {{-- <span class="assigned-badge assigned-{{ $currentProvider['assigned'] }}">
                                                            Assigned: {{ $currentProvider['assigned'] }}
                                                        </span> --}}
                                                    </div>
                                                    <div class="mt-2">
                                                        {{-- <small class="text-muted">Payment Type: {{ $currentProvider['name'] }}</small> --}}
                                                        <br>
                                                        <small class="text-muted">Price: PKR {{ number_format($currentProvider['price'], 2) }}</small>
                                                        <br>
                                                        <small class="text-muted">Since: {{ $currentProvider['created_at'] }}</small>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-4 mb-4">
                                                <div class="card provider-card">
                                                    <div class="card-body text-center">
                                                        ...
                                                        <div class="mt-2">
                                                            <span class="status-badge status-bidded">Bidded</span>
                                                            <span class="assigned-badge assigned-{{ $provider['assigned'] }}">
                                                                Assigned: {{ $provider['assigned'] }}
                                                            </span>
                                                        </div>
                                                        <div class="mt-2">
                                                            <small class="text-muted">Price: PKR {{ number_format($provider['price'], 2) }}</small>
                                                            <br>
                                                            <small class="text-muted">Bidded: {{ $provider['bidded_at'] }}</small>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
