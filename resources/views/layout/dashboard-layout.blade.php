        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <nav class="navbar navbar-expand-lg main-navbar sticky">
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="p-2">
                        <a href="{{ route('chatsList') }}" class="btn btn-primary text-white"><i data-feather="message-circle"></i></a>
                    </li>
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown {{ request()->routeIs('main-categories.index') ||  request()->routeIs('sub-categories.index') ? 'active' : ' '}}">
                            <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="layers"></i><span>Skill Categories</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ route('main-categories.index')  }}">Main Categories</a></li>
                            </ul>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ route('sub-categories.index')  }}">Sub Categories</a></li>
                            </ul>
                        </li>
                        <li class="dropdown  {{ request()->routeIs('chatsList') ? 'active' : ' '}}">
                            <a href="{{ route('chatsList') }}" class="nav-link"><i data-feather="message-circle"></i><span>Chat List</span></a>
                        </li>
                        ...
                        <li class="dropdown  {{ request()->routeIs('allProviders')  ||  request()->routeIs('approvedProviders') || request()->routeIs('suspendedProviders') || request()->routeIs('blockedProviders') || request()->routeIs('pendingProviders') ? 'active' : ' '}}">
                            <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="users"></i><span>Providers</span></a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown  {{ request()->routeIs('allRequest') ? 'active' : ' '}}">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ route('approvedRequest')  }}">Approved Request</a></li>
                            </ul>
                        </li>
                        <li class="dropdown  {{ request()->routeIs('pendingBooking') ? 'active' : ' '}} {{ request()->routeIs('startBooking') ? 'active' : ' '}}   {{ request()->routeIs('cancelBooking') ? 'active' : ' '}} {{ request()->routeIs('allBookings') ? 'active' : ' '}} {{ request()->routeIs('endBooking') ? 'active' : ' '}}">
                            <a href="#" class="menu-toggle nav-link has-dropdown"><i class="fas fa-calendar-alt"></i>
                                <span>Booking</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ route('allBookings')  }}"> All Bookings</a></li>
                            </ul>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ route('pendingBooking')  }}">Pending Bookings</a></li>
                            </ul>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown  {{ request()->routeIs('shopkeepers') || request()->routeIs('shops') ? 'active' : ' '}}">
                        ...
                        <li class="dropdown  {{ request()->routeIs('tax.index') ? 'active' : ' '}}">
                            <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="settings"></i>

                                <span>Setting</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ route('tax.index') }}">Tax</a></li>
                            </ul>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ route('appUrl.index') }}">App Url</a></li>
                            </ul>
                        </li>
