                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header"
                                ...
                                <h4>Blocked Providers List</h4>
                                @include('components.export-button', [
                                    'apiUrl' => route('providers.export'),
                                    'fileName' => 'blocked_providers',
                                    'queryParams' => array_merge(request()->all(), ['status' => 'blocked']),
                                    'buttonLabel' => 'Export',
                                ])
                            </div>
                                            ...
                                            @if ($data->isNotEmpty())
                                                @foreach ($data as $provider)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span
                                                                class="badge {{ $provider->status == 'approved' ? 'badge-success' : 'badge-warning' }} {{ $provider->status == 'blocked' ? 'badge-danger' : 'badge-warning' }}">{{ $provider->status }}</span>
                                                        </td>
